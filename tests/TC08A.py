...
for article in articles:
    if MOCK_COMMENT in article.text:
        elem = article.find_element(By.XPATH, ".//a[contains(text(), 'Delete')]")
        elem.click()
        time.sleep(1)
...
if MOCK_COMMENT not in driver.page_source and "Whitelabel Error Page" not in driver.page_source:
    print("DELETE COMMENT TEST PASSED")
else:
    print("DELETE COMMENT TEST FAILED")
